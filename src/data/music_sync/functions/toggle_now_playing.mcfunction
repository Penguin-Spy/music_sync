...
tellraw @s[tag=music_sync.show_now_playing] {"translate":"music_sync.toggle_now_playing.enabled", "color": "green", "fallback": "'Now playing' display enabled"}
tellraw @s[tag=!music_sync.show_now_playing] {"translate":"music_sync.toggle_now_playing.disabled", "color": "red", "fallback": "'Now playing' display disabled"}